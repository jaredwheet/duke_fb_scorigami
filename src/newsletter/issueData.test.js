...
test('uses canonical player names in a second-half touchdown moment', () => {
  ...
  expect(data.turning_point).toMatchObject({ type: 'win_probability_swing', description: 'Duke\'s win expectancy jumped 11.6 points when Walker Eget found Nate Sheppard for 3 yards and a touchdown with 10:47 left in the third quarter (Duke 28, Illinois 24).' });
});
