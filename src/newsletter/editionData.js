...
export function buildVictoryBellBulletinIssueData(issueData, { issueDate, odds = null } = {}) {
  ...
  return {
    ...
    brief_sections: [
      ...
      { label: 'DUKE LEADERS', detail: 'The five names to know from Duke.', rows: context.dukePlayerRows },
      { label: `${opponent.toUpperCase()} LEADERS`, detail: `The five names to know from ${opponent}.`, rows: context.opponentPlayerRows },
